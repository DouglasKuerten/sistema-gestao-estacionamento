                ...
                <div className="space-y-12">
                    <div className="border-b border-gray-900/10 pb-12">
                        <div className=" grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <Input type="text" name="cliente" id="cliente" autoComplete="off" label="Placa" placeholder="" obrigatory={'YES'} />
                            ...
                            <Input type="datetime-local" name="cliente" id="cliente" autoComplete="off" label="Data/Hora Saída" placeholder="" obrigatory={'YES'} />
